...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://qrcodegenerator.vercel.app/qr-code-scanner",
  },
  openGraph: {
    title: "Free QR Code Scanner — Scan QR Codes Online Without an App",
    description:
      "Scan QR codes online directly in your browser — upload an image or use your camera. No app, no signup, 100% free. Decodes URLs, text, UPI, vCard, and more. Works on mobile and desktop.",
    url: "https://qrcodegenerator.vercel.app/qr-code-scanner",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "QR Code Scanner", item: "https://qrcodegenerator.vercel.app/qr-code-scanner" },
  ],
};
